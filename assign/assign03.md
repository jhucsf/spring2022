...
* Milestone 3: Thursday, Mar 31st by 11pm (max 48 late hours; more with permission only)
...
```
curl -O https://jhucsf.github.io/spring2022/assign/assign03/read01.trace
```
